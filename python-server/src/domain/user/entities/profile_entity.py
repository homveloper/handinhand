...
def profile_entity_from_dict(s: Any) -> ProfileEntity:
    return ProfileEntity.from_dict(s)


def profile_entity_to_dict(x: ProfileEntity) -> Any:
    return to_class(ProfileEntity, x)
