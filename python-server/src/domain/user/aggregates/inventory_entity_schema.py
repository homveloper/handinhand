...
class InventoryEntitySchema:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'InventoryEntitySchema':
        assert isinstance(obj, dict)
        ...
        return InventoryEntitySchema(capacity, gems, gold, items)
...
def inventory_entity_schema_from_dict(s: Any) -> InventoryEntitySchema:
    return InventoryEntitySchema.from_dict(s)


def inventory_entity_schema_to_dict(x: InventoryEntitySchema) -> Any:
    return to_class(InventoryEntitySchema, x)
